...
import signin from "../assets/signin-img.png"; // Local image import
import eyeIcon from "../assets/eye-icon.png"; // Eye icon for password visibility
    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.container}>
        ...
        <View style={styles.formContainer}>
          ...
          <Text style={styles.forgotPassword} onPress={() => Alert.alert('Forgot Password', 'Password recovery logic goes here')}>
            Forgot Password?
          </Text>
