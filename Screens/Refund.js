  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.paragraph}>
        Vishu Jewellery reserves the right to decline a return if the product is found to be used, damaged, or missing essential components. We encourage customers to review product descriptions and specifications before placing an order.Thank you for shopping with VishuJewellery!
        </Text>
