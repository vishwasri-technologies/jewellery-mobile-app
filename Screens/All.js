...
{ id: '601', image: require('../assets/categories/Women/Bracelet-1.png'), name: 'Pastel Colour Stones Bracelet', price: '\u20B9299', material: "Copper", care: "Clean with a soft, dry cloth",colour: "White Colour",category:"Bracelets" },
  ...
  { id: '603', image: require('../assets/categories/Women/Necklace-34.png'), name: 'Princess Unique Jewellery Sets With Earrings', price: '\u20B9499', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
  ...
  { id: '606', image: require('../assets/categories/Women/Chain-1.png'), name: 'Simple Plain Gold Colour Chains', price: '\u20B9299', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Chains" },
  { id: '607', image: require('../assets/categories/Women/Necklace-8.png'), name: 'Gold Plated Ruby Kundan Studded Jewellery Set', price: '\u20B91599', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
  ...
  { id: '619', image: require('../assets/categories/Women/Ear-12.png'), name: 'Lakshmi Pearl Temple Earrings', price: '\u20B9459', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Ear Rings" },
  ...
  { id: '626', image: require('../assets/categories/Women/Necklace-23.png'), name: 'Terndy Gold Plated Jewellery Set', price: '\u20B91999', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
  ...
  { id: '636', image: require('../assets/categories/Women/Necklace-27.png'), name: 'New Designer Lakshmi Pendant Jewellery Set ', price: '\u20B91699', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
  ...
  { id: '638', image: require('../assets/categories/Women/Necklace-22.png'), name: 'Simple Necklace And Earring Set For Women', price: '\u20B9399', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
...
{ id: '644', image: require('../assets/categories/Women/Bangle-9.png'), name: 'Traditional Festive Wear Bangles Set', price: '\u20B9499', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Multy Colour",category:"Bangles" },
  ...
  { id: '652', image: require('../assets/categories/Women/Necklace-7.png'), name: 'Elegant gold-plated Pearl Stone Design Necklace', price: '\u20B9780', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
  ...
  { id: '654', image: require('../assets/categories/Women/Necklace-1.png'), name: 'Royal Temple Gold Plated Haram Set', price: '\u20B9599', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
...
{ id: '659', image: require('../assets/categories/Women/Necklace-31.png'), name: 'Necklace And Earring Set For Women', price: '\u20B91899', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
{ id: '660', image: require('../assets/categories/Women/Bangle-18.png'), name: 'Set of 2 Pearls Studded Bangles', price: '\u20B9299', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Bangles" },
  ...
  { id: '662', image: require('../assets/categories/Women/Necklace-24.png'), name: 'Gold-Plated Divine Lakshmi Motif Temple Jewellery Set ', price: '\u20B9499', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
  { id: '663', image: require('../assets/categories/Women/Necklace-25.png'), name: 'Gold Plated Simple Long Necklace For Women', price: '\u20B9399', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
  { id: '664', image: require('../assets/categories/Women/Necklace-26.png'), name: 'Gold-Plated Stone-Studded & Beaded Jewellery Set', price: '\u20B9299', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
  ...
  { id: '668', image: require('../assets/categories/Women/Necklace-32.png'), name: 'Gold Flower Shaped With Pink Stone Necklace', price: '\u20B9499', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
  { id: '669', image: require('../assets/categories/Women/Necklace-36.png'), name: 'South Indian Bridal Double Necklace Jewellery Set ', price: '\u20B91599', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
...
{ id: '671', image: require('../assets/categories/Women/Bangle-15.png'), name: 'Gold-Plated Studded Chuda Bangles ', price: '\u20B9499', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Bangles" },
    ...
    { id: '676', image: require('../assets/categories/Women/Necklace-14.png'), name: 'Gold-Plated Plear Stone-Studded Necklace', price: '\u20B9699', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
    ...
    { id: '678', image: require('../assets/categories/Women/Necklace-29.png'), name: 'Fancy jewellery set for women and girls', price: '\u20B9499', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold & Blue Colour",category:"Necklace" },
   ...
   { id: '680', image: require('../assets/categories/Women/Necklace-20.png'), name: 'Gold-Plated Studded Temple Jewellery Set', price: '\u20B92999', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
  { id: '681', image: require('../assets/categories/Women/Necklace-28.png'), name: 'Ethnic Golden Color Designer Pendent Set', price: '\u20B93999', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
  { id: '682', image: require('../assets/categories/Women/Necklace-2.png'), name: 'Pearl Temple Necklace', price: '\u20B9780', material: "Copper", care: "Clean with a soft, dry cloth",colour: "Gold Colour",category:"Necklace" },
