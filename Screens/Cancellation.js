...
const styles = StyleSheet.create({
  container: { flex: 1, padding: 20, backgroundColor: "#fff",width:"102%",marginBottom:hp(0), },
  title: { fontSize: 24, fontWeight: "bold", marginBottom: 15 },
  heading1: { fontSize: 18, fontWeight: "bold", marginTop: 10 ,paddingBottom:5,},
  paragraph: { fontSize: 16, lineHeight: 22, marginBottom: 7 },
  header: {
    flexDirection: 'row',  
    alignItems: 'center',  
