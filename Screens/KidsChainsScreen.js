...
const kidschainProducts = [
  { id: '38', image: require('../assets/categories/Men-bracelets.png'), name: 'Gold Bracelet', price: '\u20B9150' },
  { id: '39', image: require('../assets/categories/Men-bracelets.png'), name: 'Silver Bracelet', price: '\u20B9120' },
...
const  KidsChainsScreen = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>kidschains</Text>
      <FlatList
        data={kidschainProducts}
